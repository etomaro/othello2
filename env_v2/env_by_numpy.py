...
"""
import numpy as np
from numba import jit, vectorize, prange, guvectorize, int64
...
@guvectorize([(int64[:], int64[:])], '(n)->()', target='parallel')
...
@guvectorize([(int64[:], int64[:], int64[:])], '(n),(m)->(m)')
def step_parallel(actions, dummy, out):
    ...
    if tmp_black_board < next_black_board:
        next_black_board = tmp_black_board
        next_white_board = _get_y(next_white_board)
    elif tmp_black_board == next_black_board:
        tmp_white_board = _get_y(next_white_board)
        if tmp_white_board < next_white_board:
            next_black_board = tmp_black_board
            next_white_board = tmp_white_board
    # 2. get_x
    tmp_black_board = _get_x(next_black_board)
    if tmp_black_board < next_black_board:
        next_black_board = tmp_black_board
        next_white_board = _get_x(next_white_board)
    elif tmp_black_board == next_black_board:
    ...
    if tmp_black_board < next_black_board:
        next_black_board = tmp_black_board
        next_white_board = _get_right_z(next_white_board)
    elif tmp_black_board == next_black_board:
    ...
    if tmp_black_board < next_black_board:
        next_black_board = tmp_black_board
        next_white_board = _get_left_z(next_white_board)
    elif tmp_black_board == next_black_board:
    ...
    if tmp_black_board < next_black_board:
        next_black_board = tmp_black_board
        next_white_board = _get_rotato90(next_white_board)
    elif tmp_black_board == next_black_board:
    ...
    if tmp_black_board < next_black_board:
        next_black_board = tmp_black_board
        next_white_board = _get_rotato180(next_white_board)
    elif tmp_black_board == next_black_board:
    ...
    if tmp_black_board < next_black_board:
        next_black_board = tmp_black_board
        next_white_board = _get_rotato270(next_white_board)
    elif tmp_black_board == next_black_board:
    ...
    out[0] = next_black_board
    out[1] = next_white_board
    out[2] = next_player
